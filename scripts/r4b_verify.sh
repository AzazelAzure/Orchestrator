#!/usr/bin/env bash
# R4B local verification — run from Orchestrator repo root.
set -euo pipefail
...
pytest -q --cache-clear tests/unit/test_r4_*.py tests/unit/test_r4b_*.py
...
echo "R4B verification finished"
