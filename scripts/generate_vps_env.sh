...
umask 077
{
  ...
  echo "DJANGO_ALLOWED_HOSTS=api.thedirectorate.dev,127.0.0.1,localhost"
  echo "CORS_ALLOWED_ORIGINS=https://www.thedirectorate.dev"
  echo "CSRF_TRUSTED_ORIGINS=https://www.thedirectorate.dev,https://api.thedirectorate.dev"
  ...
  echo "VITE_API_BASE_URL=https://api.thedirectorate.dev"
} >"$ENV_FILE"
chmod 600 "$ENV_FILE"
